...
createChannel(){
    ...
    peer channel create -o localhost:7050 -c $CHANNEL_NAME --ordererTLSHostnameOverride orderer.example.com -f ../docker/${CHANNEL_NAME}.tx --outputBlock ../hyperledger/blocks/${CHANNEL_NAME}.block --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA
}
